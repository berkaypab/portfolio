...
export const ScrollToTop: React.FC = () => {
  ...
  return (
    ...
    >
      <motion.div
        className="w-12 h-12 flex items-center justify-center rounded-full bg-[var(--surface)] text-[var(--text)] border border-[var(--border)] shadow-md hover:bg-[var(--bg)] transition-colors"
        initial={{ y: 0 }}
        animate={
